...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{hyperref}
\usepackage{graphicx} % libreria para poder añadir imágenes
...
\title{\Huge \textbf{Universidad Autónoma del Estado de Hidalgo} % \footnote{This is a footnote.} 
\\ \huge Asignatura: Minería de datos 
\\ \huge Proyecto  %\footnote{This is yet another footnote.}
}
...
% Agrega imagen del escudo
\begin{figure}[ht!]
\centering
\includegraphics[width=100mm]{img.png}
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{dedication}
Dedicated to Calvin and Hobbes. LOL.
\end{dedication}
...
%%%%%%%%%%%%%%%%
% DEFINICION DE CAPITULO 1 %
%%%%%%%%%%%%%%%%
\chapter{Capítulo 1: Algoritmos de Minería de Datos}
...
\section{Máquinas de soporte de vectores}
...
%%%%%%%%%%%%%%%%
% DEFINICION DE CAPITULO 2 %
%%%%%%%%%%%%%%%%
\chapter{Capítulo 2: Weka}
...
% -----------------------
%%%%%%%%%%%%%%%%
% DEFINICION DE CAPITULO 3 %
%%%%%%%%%%%%%%%%
\chapter{Capítulo 3: Resultados experimentales}
